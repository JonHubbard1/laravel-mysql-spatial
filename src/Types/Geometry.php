...
namespace JonHubbard1\LaravelMysqlSpatial\Types;

use GeoIO\WKB\Parser\Parser;
use GeoJson\GeoJson;
use JonHubbard1\LaravelMysqlSpatial\Exceptions\UnknownWKTTypeException;
...
abstract class Geometry implements GeometryInterface, Jsonable, \JsonSerializable
{
    ...
    public static function fromJson($geoJson)
    {
        ...
        $type = '\JonHubbard1\LaravelMysqlSpatial\Types\\'.$geoJson->getType();
